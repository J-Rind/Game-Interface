...
public class Board {
    ...
    public void setFront(int row, ArrayList<com.company.Piece> pieces, String color){
        ...
        for(int y = 0; y < 8; y++){
            //make piece object
            Piece thisPiece = new Piece(row,y,"Pawn",colorCheck);
        ...
        for(int y = 0; y < 8; y++){
            switch(y){
                case 0:
                    ...
                    Rook rookPiece = new Rook(row,y,"Rook",colorCheck);
